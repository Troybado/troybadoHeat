...
export class ExporterComponent implements OnInit {
	...
	const customNames = {
	  "Reconnaissance": "Reconnaissance (3/10)",
	  "Resource Development": "ResourceDevelopment (4/7)",
	  "Initial Access": "Initial Access (6/9)",
	  "Execution": "Execution (6/13)",
	  "Persistence": "Persistence (12/19)",
	  "Privilege Escalation": "Privilege Escalation (7/13)",
	  "Defense Evasion": "Defense Evasion (16/42)",
	  "Credential Access": "Credential Access (5/17)",
	  "Discovery": "Discovery (5/30)",
	  "Lateral Movement": "Lateral Movement (6/9)",
	  "Collection": "Collection (3/17)",
	  "Commandand and Control": "Commandand Control (10/16)",
	  "Exfiltration": "Exfiltration (7/9)",
	  "Impact": "Impact (4/13)"
	};
		...
		let tacticname = tactic.tactic.name;
		if (customNames.hasOwnProperty(tactic.tactic.name)) {
		    tacticname = customNames[tactic.tactic.name];
		}
